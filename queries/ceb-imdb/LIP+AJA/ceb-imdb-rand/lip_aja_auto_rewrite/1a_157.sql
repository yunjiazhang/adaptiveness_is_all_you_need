...
SELECT sum(pg_lip_bloom_add(0, mi1.movie_id)) FROM movie_info AS mi1 
        WHERE ((mi1.info_type_id = 3) AND (mi1.info = ANY ('{Adventure,Comedy,Crime,Drama,Family,Western}'::text[])));


/*+
NestLoop(mi2 t kt mi1 ci rt n it1 it2)
NestLoop(mi2 t kt mi1 ci rt n it1)
