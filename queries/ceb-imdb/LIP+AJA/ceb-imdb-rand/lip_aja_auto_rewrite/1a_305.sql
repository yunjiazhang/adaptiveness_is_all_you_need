...
WHERE 
 ...
 AND mi1.info IN ('Brazil','China','Finland','Israel','Italy','Malaysia','Philippines','Serbia','Spain','USA') 
 AND mi2.info IN ('English','French','Galician','Malay','Russian','Serbian','Spanish','Swedish') 
