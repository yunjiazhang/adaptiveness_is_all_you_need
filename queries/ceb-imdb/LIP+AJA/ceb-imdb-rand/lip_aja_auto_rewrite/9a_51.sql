...
WHERE 
 ...
 AND (kt.kind IN ('episode','movie','tv mini series','video movie')) 
 AND (rt.role IN ('actor','actress','composer','costume designer','editor','guest','producer','production designer','writer')) 
