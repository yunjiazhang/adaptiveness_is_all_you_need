...
SELECT sum(pg_lip_bloom_add(0, mi2.movie_id)) FROM movie_info AS mi2 
        WHERE ((mi2.info_type_id = 4) AND (mi2.info = ANY ('{Danish,English,Greek,Japanese,Spanish,Tagalog}'::text[])));
...
WHERE 
 ...
 AND mi1.info IN ('Action','Comedy','Crime','Documentary','History','Reality-TV','Romance','Talk-Show','War','Western') 
 AND mi2.info IN ('Danish','English','Greek','Japanese','Spanish','Tagalog') 
