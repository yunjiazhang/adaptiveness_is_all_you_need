...
SELECT sum(pg_lip_bloom_add(0, mi2.movie_id)) FROM movie_info AS mi2 
        WHERE ((mi2.info_type_id = 4) AND (mi2.info = ANY ('{Cantonese,English,French,Hungarian,Norwegian}'::text[])));
...
WHERE 
 ...
 AND mi1.info IN ('Hong Kong','Hungary','Ireland','Norway','USA') 
 AND mi2.info IN ('Cantonese','English','French','Hungarian','Norwegian') 
