...
SELECT sum(pg_lip_bloom_add(2, n.id)) FROM name AS n 
        WHERE (((n.gender)::text = ANY ('{f,m}'::text[])) AND ((n.name_pcode_cf)::text = ANY ('{D1232,H4236,O4252,P5235,R363,S3152,W5165}'::text[])));
...
WHERE 
 ...
 AND (n.gender in ('f','m')) 
 AND (n.name_pcode_cf in ('D1232','H4236','O4252','P5235','R363','S3152','W5165')) 
