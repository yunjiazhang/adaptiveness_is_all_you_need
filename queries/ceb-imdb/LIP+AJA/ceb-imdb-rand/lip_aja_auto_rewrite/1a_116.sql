...
SELECT sum(pg_lip_bloom_add(0, mi1.movie_id)) FROM movie_info AS mi1 
        ...
        -- AND (mi1.info = ANY ('{Action,Adventure,Comedy,Documentary,Drama,Family,Romance}'::text[]))
        ;
...
AND mi1.info IN ('Action','Adventure','Comedy','Documentary','Drama','Family','Romance') 
