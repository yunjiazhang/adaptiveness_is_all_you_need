...
SELECT sum(pg_lip_bloom_add(0, cn.id)) FROM company_name AS cn 
        WHERE ((cn.country_code)::text = '[th]'::text);
...
WHERE 
 ...
 AND k.keyword IN ('father-son-relationship','female-frontal-nudity','friendship','gun','lesbian','nudity','singer','singing','suicide','tv-mini-series') 
