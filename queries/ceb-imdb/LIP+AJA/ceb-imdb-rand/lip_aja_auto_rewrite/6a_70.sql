...
SELECT sum(pg_lip_bloom_add(0, mi1.movie_id)), sum(pg_lip_bloom_add(1, mi1.movie_id)) FROM movie_info AS mi1 
        WHERE (mi1.info = ANY ('{Argentina:13,Argentina:Atp,Australia:PG,France:U,Portugal:M/12,Singapore:PG,UK:15,UK:18,"USA:Not Rated",USA:R,USA:TV-14}'::text[])) AND (mi1.info = ANY ('{Argentina:13,Argentina:Atp,Australia:PG,France:U,Portugal:M/12,Singapore:PG,UK:15,UK:18,"USA:Not Rated",USA:R,USA:TV-14}'::text[]));
...
SELECT sum(pg_lip_bloom_add(3, n.id)) FROM name AS n 
        WHERE (((n.gender)::text = 'm'::text) AND (((n.name_pcode_nf)::text = ANY ('{A353,A3562,D5463,E6214,G5362,G624,H6252,J6251,L5631,P3653,R252,S6216,T5256}'::text[])) OR (n.name_pcode_nf IS NULL)));
...
WHERE 
 ...
 AND (mi1.info IN ('Argentina:13','Argentina:Atp','Australia:PG','France:U','Portugal:M/12','Singapore:PG','UK:15','UK:18','USA:Not Rated','USA:R','USA:TV-14')) 
 AND (it1.id IN ('110','5','97')) 
 AND it3.id = '100' 
 AND it4.id = '101' 
 ...
 AND (n.gender in ('m')) 
 AND (n.name_pcode_nf in ('A353','A3562','D5463','E6214','G5362','G624','H6252','J6251','L5631','P3653','R252','S6216','T5256') OR n.name_pcode_nf IS NULL) 
 AND (ci.note IS NULL) 
