...
SELECT sum(pg_lip_bloom_add(0, mi1.movie_id)) FROM movie_info AS mi1 
        WHERE ((mi1.info_type_id = 8) AND (mi1.info = ANY ('{Argentina,Brazil,France,Germany,Italy,Portugal,"Soviet Union",Spain,UK,USA}'::text[])));
...
WHERE 
 ...
 AND (mi1.info in ('Argentina','Brazil','France','Germany','Italy','Portugal','Soviet Union','Spain','UK','USA')) 
