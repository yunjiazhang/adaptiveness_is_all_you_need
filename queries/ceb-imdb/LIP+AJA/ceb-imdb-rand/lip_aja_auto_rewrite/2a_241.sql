...
SELECT sum(pg_lip_bloom_add(0, mi1.movie_id)) FROM movie_info AS mi1 
        WHERE ((mi1.info_type_id = 4) AND (mi1.info = ANY ('{Arabic,Dutch,English,Filipino,German,Italian,Spanish,Tamil}'::text[])));
...
WHERE 
 ...
 AND (mi1.info in ('Arabic','Dutch','English','Filipino','German','Italian','Spanish','Tamil')) 
 AND (mi2.info in ('Argentina','Australia','Belgium','Egypt','Germany','India','Italy','New Zealand','Philippines','UK')) 
