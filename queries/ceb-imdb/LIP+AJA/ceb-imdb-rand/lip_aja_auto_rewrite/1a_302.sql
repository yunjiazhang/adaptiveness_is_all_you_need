...
WHERE 
 ...
 AND mi1.info IN ('Comedy','Documentary','Drama','Fantasy','Romance','Short','Thriller') 
 AND mi2.info IN ('OFM:16 mm','OFM:35 mm','PCS:Spherical','PFM:35 mm','RAT:1.33 : 1','RAT:1.78 : 1 / (high definition)','RAT:1.78 : 1','RAT:1.85 : 1','RAT:16:9 HD') 
