...
HashJoin(mi1 mc cn t ct kt ci rt n)
...
WHERE 
 ...
 AND (kt.kind ILIKE '%m%') 
 AND (rt.role IN ('actor','actress','cinematographer','costume designer','director','miscellaneous crew','producer','production designer')) 
