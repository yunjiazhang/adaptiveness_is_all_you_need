...
WHERE 
 ...
 AND (mi2.info in ('Cantonese','Czech','English','Finnish','French','German','Hebrew','Hindi','Italian','Polish','Portuguese','Serbo-Croatian','Spanish')) 
 AND (kt.kind in ('episode','movie','video movie')) 
 AND (rt.role in ('cinematographer','production designer')) 
 AND (n.gender in ('f','m')) 
 AND (t.production_year <= 2010) 
 AND (t.production_year >= 1950) 
 AND (k.keyword IN ('bare-breasts','character-name-in-title','death','female-frontal-nudity','female-nudity','gay','hospital','independent-film','lesbian','lesbian-sex','mother-daughter-relationship','new-york-city','nudity','party','singer','singing')) 
