...
WHERE 
 ...
 AND (mi1.info IN ('Argentina:13','Argentina:Atp','Australia:G','Australia:M','Australia:PG','Dolby Digital','Dolby SR','Dolby','Finland:K-16','Mono','Netherlands:12','Silent','Stereo','Sweden:15','UK:15','UK:PG','USA:Approved','USA:Not Rated','USA:R')) 
 AND (it1.id IN ('5','6')) 
 AND it3.id = '100' 
 AND it4.id = '101' 
 ...
 AND (n.name_pcode_nf in ('A5362','F6521','G6232','H5625','J1625','J2125','J5212','M6353','R2631','S1526','T5263','V2363')) 
