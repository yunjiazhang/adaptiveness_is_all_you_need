...
WHERE 
 ...
 AND (kt.kind IN ('movie','tv mini series','tv series','video movie')) 
 AND (rt.role IN ('actor','actress','composer','director','editor','guest','miscellaneous crew','producer','production designer','writer')) 
