...
SELECT sum(pg_lip_bloom_add(0, mi1.movie_id)) FROM movie_info AS mi1 
        WHERE ((mi1.info_type_id = 3) AND (mi1.info = ANY ('{Comedy,Documentary,History,Thriller,Western}'::text[])));
...
WHERE 
 ...
 AND mi1.info IN ('Comedy','Documentary','History','Thriller','Western') 
 AND mi2.info IN ('MET:150 m','OFM:35 mm','OFM:68 mm','RAT:1.33 : 1','RAT:2.35 : 1') 
