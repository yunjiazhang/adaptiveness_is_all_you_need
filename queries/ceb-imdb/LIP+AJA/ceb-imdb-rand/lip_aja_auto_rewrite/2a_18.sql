...
SELECT sum(pg_lip_bloom_add(0, mi2.movie_id)) FROM movie_info AS mi2 
        WHERE ((mi2.info_type_id = 4) AND (mi2.info = ANY ('{Dutch,English,German}'::text[])));
...
WHERE 
 ...
 AND (mi1.info in ('Argentina:Atp','Australia:PG','Belgium:KT','UK:A','USA:Not Rated','USA:Passed','West Germany:12')) 
 AND (mi2.info in ('Dutch','English','German')) 
