...
SELECT sum(pg_lip_bloom_add(0, mi2.movie_id)) FROM movie_info AS mi2 
        WHERE ((mi2.info_type_id = 3) AND (mi2.info = ANY ('{Animation,Documentary,Drama,Horror,Short}'::text[])));
...
WHERE 
 ...
 AND (mi1.info in ('10','104','33','40','7','8','82','85','87','USA:15')) 
 AND (mi2.info in ('Animation','Documentary','Drama','Horror','Short')) 
