...
WHERE 
 ...
 AND (rt.role in ('actor','actress','composer','director','miscellaneous crew')) 
 AND (n.gender in ('f','m') OR n.gender IS NULL) 
 AND (n.surname_pcode in ('B65','C5','H4','J525','M62','M635','N425','R2','S53','T46') OR n.surname_pcode IS NULL) 
