...
/*+
NestLoop(it2 it1 mi1 ci pi n t kt rt)
NestLoop(it1 mi1 ci pi n t kt rt)
HashJoin(mi1 ci pi n t kt rt)
HashJoin(mi1 ci pi n t kt)
HashJoin(ci pi n t kt)
HashJoin(ci pi n)
NestLoop(pi n)
HashJoin(t kt)
SeqScan(it2)
...
SeqScan(rt)
SeqScan(t)
Leading((it2 (it1 ((mi1 ((ci (pi n)) (t kt))) rt))))
*/
