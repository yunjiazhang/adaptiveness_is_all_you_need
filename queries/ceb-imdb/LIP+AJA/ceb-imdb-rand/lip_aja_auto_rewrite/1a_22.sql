...
SELECT sum(pg_lip_bloom_add(0, mi2.movie_id)) FROM movie_info AS mi2 
        WHERE ((mi2.info_type_id = 4) AND (mi2.info = ANY ('{Czech,Dutch,English,German,Hebrew,Korean,Polish}'::text[])));
...
WHERE 
 ...
 AND mi1.info IN ('Belgium','Czech Republic','France','Germany','India','Israel','Netherlands','Nigeria','Poland','South Korea','Spain','UK','West Germany') 
 AND mi2.info IN ('Czech','Dutch','English','German','Hebrew','Korean','Polish') 
