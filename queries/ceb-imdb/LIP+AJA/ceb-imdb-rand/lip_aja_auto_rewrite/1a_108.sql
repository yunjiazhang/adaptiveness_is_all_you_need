...
WHERE 
 ...
 AND mi1.info IN ('Austria','Croatia','Czech Republic','Denmark','East Germany','Germany','Israel','Sweden','Switzerland','UK','USA','Venezuela') 
 AND mi2.info IN ('Croatian','English','French','German','Japanese','Spanish') 
