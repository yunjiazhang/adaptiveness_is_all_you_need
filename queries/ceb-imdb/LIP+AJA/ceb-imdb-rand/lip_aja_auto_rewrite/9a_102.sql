...
WHERE 
 ...
 AND (kt.kind IN ('movie','tv mini series','tv movie','tv series')) 
 AND (rt.role IN ('actor','actress','costume designer','director','editor','guest','producer','production designer','writer')) 
