...
SELECT sum(pg_lip_bloom_add(0, mi1.movie_id)), sum(pg_lip_bloom_add(1, mi1.movie_id)) FROM movie_info AS mi1 
        WHERE (mi1.info = 'UK'::text) AND (mi1.info = 'UK'::text);
SELECT sum(pg_lip_bloom_add(2, n.id)) FROM name AS n 
        WHERE ((((n.gender)::text = ANY ('{f,m}'::text[])) OR (n.gender IS NULL)) AND ((n.name_pcode_nf)::text = ANY ('{A4163,B6161,B6563,D1316,F6521,F6523,F6524,J3261,J5216,J525,J5262,P3616,R1635,R3565,W4362}'::text[])));
...
WHERE 
 ...
 AND (n.name_pcode_nf in ('A4163','B6161','B6563','D1316','F6521','F6523','F6524','J3261','J5216','J525','J5262','P3616','R1635','R3565','W4362')) 
 AND (ci.note IS NULL) 
