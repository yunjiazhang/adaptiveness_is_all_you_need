...
SELECT sum(pg_lip_bloom_add(0, mi2.movie_id)) FROM movie_info AS mi2 
        WHERE ((mi2.info_type_id = 4) AND (mi2.info = ANY ('{Cantonese,English,French,Italian,Japanese,Russian}'::text[])));
...
WHERE 
 ...
 AND mi1.info IN ('Canada','Hong Kong','Ireland','Italy','Japan','Netherlands','Russia','UK') 
 AND mi2.info IN ('Cantonese','English','French','Italian','Japanese','Russian') 
