...
SELECT sum(pg_lip_bloom_add(0, mi2.movie_id)) FROM movie_info AS mi2 
        WHERE ((mi2.info_type_id = 7) AND (mi2.info = ANY ('{PCS:Spherical,"PFM:35 mm","RAT:1.33 : 1"}'::text[])));
...
WHERE 
 ...
 AND mi1.info IN ('Crime','Family','Horror') 
 AND mi2.info IN ('PCS:Spherical','PFM:35 mm','RAT:1.33 : 1') 
