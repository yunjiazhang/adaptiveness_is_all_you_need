...
SELECT sum(pg_lip_bloom_add(0, mi1.movie_id)) FROM movie_info AS mi1 
        WHERE ((mi1.info_type_id = 8) AND (mi1.info = ANY ('{Australia,Canada,France,USA}'::text[])));
...
WHERE 
 ...
 AND (mi1.info in ('Australia','Canada','France','USA')) 
 AND (mi2.info in ('London, England, UK','Los Angeles, California, USA','Paris, France','Philadelphia, Pennsylvania, USA','Sydney, New South Wales, Australia','Vancouver, British Columbia, Canada')) 
