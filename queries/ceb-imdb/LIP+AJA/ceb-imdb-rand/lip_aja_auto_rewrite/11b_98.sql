...
WHERE 
 ...
 AND (kt.kind IN ('movie','tv mini series','tv movie','tv series','video game')) 
 AND (rt.role IN ('actress','cinematographer','costume designer','director','editor','guest','producer','writer')) 
