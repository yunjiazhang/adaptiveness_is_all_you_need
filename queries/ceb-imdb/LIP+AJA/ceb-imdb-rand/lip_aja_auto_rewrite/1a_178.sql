...
SELECT sum(pg_lip_bloom_add(0, mi2.movie_id)) FROM movie_info AS mi2 
        WHERE ((mi2.info_type_id = 4) AND (mi2.info = ANY ('{Czech,English,Finnish,French,German,Hindi,Portuguese,Spanish,Turkish}'::text[])));
...
WHERE 
 ...
 AND mi1.info IN ('Argentina','Brazil','Czechoslovakia','East Germany','Finland','France','Germany','India','Mexico','Turkey','USA') 
 AND mi2.info IN ('Czech','English','Finnish','French','German','Hindi','Portuguese','Spanish','Turkish') 
