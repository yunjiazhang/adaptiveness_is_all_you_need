...
SELECT sum(pg_lip_bloom_add(1, n.id)) FROM name AS n 
        WHERE (((n.gender)::text = ANY ('{f,m}'::text[])) AND ((n.name_pcode_nf)::text = ANY ('{A4163,B6161,B6563,F6521,F6523,F6524,J3261,J5216,J5262,P3616,R1635,W4362}'::text[])));
...
WHERE 
 ...
 AND (mi1.info IN ('30','Black AND White','Color')) 
 AND (it1.id IN ('1','2','8')) 
 AND it3.id = '100' 
 AND it4.id = '101' 
 ...
 AND (n.gender in ('f','m')) 
 AND (n.name_pcode_nf in ('A4163','B6161','B6563','F6521','F6523','F6524','J3261','J5216','J5262','P3616','R1635','W4362')) 
 AND (ci.note IS NULL) 
