...
SELECT sum(pg_lip_bloom_add(0, mi1.movie_id)) FROM movie_info AS mi1 
        WHERE ((mi1.info_type_id = 3) AND (mi1.info = ANY ('{Adventure,Animation,Music,Mystery,Short}'::text[])));
...
WHERE 
 ...
 AND mi1.info IN ('Adventure','Animation','Music','Mystery','Short') 
 AND mi2.info IN ('LAB:FotoKem Laboratory, Burbank (CA), USA','OFM:Digital','PCS:Spherical','RAT:1.33 : 1','RAT:1.85 : 1') 
