...
SELECT sum(pg_lip_bloom_add(0, mi1.movie_id)), sum(pg_lip_bloom_add(1, mi1.movie_id)) FROM movie_info AS mi1 
        WHERE (mi1.info = ANY ('{"Desilu Studios - 9336 W. Washington Blvd., Culver City, California, USA","Paris, France","Toronto, Ontario, Canada","Universal Studios - 100 Universal City Plaza, Universal City, California, USA","Warner Brothers Burbank Studios - 4000 Warner Boulevard, Burbank, California, USA"}'::text[])) AND (mi1.info = ANY ('{"Desilu Studios - 9336 W. Washington Blvd., Culver City, California, USA","Paris, France","Toronto, Ontario, Canada","Universal Studios - 100 Universal City Plaza, Universal City, California, USA","Warner Brothers Burbank Studios - 4000 Warner Boulevard, Burbank, California, USA"}'::text[]));
SELECT sum(pg_lip_bloom_add(2, n.id)) FROM name AS n 
        WHERE (((n.gender)::text = 'f'::text) AND ((n.name_pcode_nf)::text = ANY ('{A4253,A5363,I2145,J2452,J3261,L5324,M6214,M6524,R2562,V6252}'::text[])));
...
WHERE 
 ...
 AND (mi1.info IN ('Desilu Studios - 9336 W. Washington Blvd., Culver City, California, USA','Paris, France','Toronto, Ontario, Canada','Universal Studios - 100 Universal City Plaza, Universal City, California, USA','Warner Brothers Burbank Studios - 4000 Warner Boulevard, Burbank, California, USA')) 
 AND (it1.id IN ('13','18')) 
 AND it3.id = '100' 
 AND it4.id = '101' 
 ...
 AND (n.gender in ('f')) 
 AND (n.name_pcode_nf in ('A4253','A5363','I2145','J2452','J3261','L5324','M6214','M6524','R2562','V6252')) 
 AND (ci.note IS NULL) 
