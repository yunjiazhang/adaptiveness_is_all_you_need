...
WHERE 
 ...
 AND (mi1.info in ('Argentina','Belgium','Canada','Czech Republic','France','Germany','Greece','India','Israel','Japan','Poland','South Korea','UK')) 
 AND (mi2.info in ('Adult','Adventure','Comedy','Crime','Documentary','Family','Musical','Short','Thriller')) 
