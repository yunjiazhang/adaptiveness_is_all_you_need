...
SELECT sum(pg_lip_bloom_add(0, mi1.movie_id)) FROM movie_info AS mi1 
        WHERE ((mi1.info_type_id = 3) AND (mi1.info = ANY ('{Action,Comedy,Crime,Documentary,Romance,Short,Thriller}'::text[])));
...
WHERE 
 ...
 AND mi1.info IN ('Action','Comedy','Crime','Documentary','Romance','Short','Thriller') 
 AND mi2.info IN ('OFM:16 mm','OFM:35 mm','RAT:1.33 : 1','RAT:1.78 : 1','RAT:1.85 : 1','RAT:2.35 : 1') 
