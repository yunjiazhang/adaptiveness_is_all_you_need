...
SELECT sum(pg_lip_bloom_add(3, n.id)) FROM name AS n 
        WHERE (((n.gender)::text = 'm'::text) AND ((n.name_pcode_nf)::text = ANY ('{A5365,B1626,B5252,B6526,D1324,E6252,F4241,G6261,G6265,J5235,J5241,M2415,M2424,S3152,S3156}'::text[])));


/*+
NestLoop(mii2 mii1 t ci rt pi1 mi1 kt it1 it3 it4 an n it5)
NestLoop(mii2 mii1 t ci rt pi1 mi1 kt it1 it3 it4 an n)
NestLoop(mii2 mii1 t ci rt pi1 mi1 kt it1 it3 it4 an)
NestLoop(mii2 mii1 t ci rt pi1 mi1 kt it1 it3 it4)
NestLoop(mii2 mii1 t ci rt pi1 mi1 kt it1 it3)
...
WHERE 
 ...
 AND (n.gender in ('m')) 
 AND (n.name_pcode_nf in ('A5365','B1626','B5252','B6526','D1324','E6252','F4241','G6261','G6265','J5235','J5241','M2415','M2424','S3152','S3156')) 
