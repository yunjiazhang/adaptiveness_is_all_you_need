...
SELECT sum(pg_lip_bloom_add(2, n.id)) FROM name AS n 
        WHERE (((n.gender)::text = ANY ('{f,m}'::text[])) AND ((n.name_pcode_nf)::text = ANY ('{A4253,A6362,B1626,C6216,C6452,D1326,J2452,J2516,J5163,J5165,J5241,J5263,L5326,P3621,R1632}'::text[])));
...
WHERE 
 ...
 AND (n.gender in ('f','m')) 
 AND (n.name_pcode_nf in ('A4253','A6362','B1626','C6216','C6452','D1326','J2452','J2516','J5163','J5165','J5241','J5263','L5326','P3621','R1632')) 
 AND (t.production_year <= 2015) 
 AND (t.production_year >= 1925) 
 AND (cn.name in ('ABS-CBN','British Broadcasting Corporation (BBC)','Columbia Broadcasting System (CBS)','Granada Television','National Broadcasting Company (NBC)','Warner Bros. Television','Warner Home Video')) 
