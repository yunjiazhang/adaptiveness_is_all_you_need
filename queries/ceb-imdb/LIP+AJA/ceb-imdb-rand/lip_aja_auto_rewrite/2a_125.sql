...
SELECT sum(pg_lip_bloom_add(0, mi2.movie_id)) FROM movie_info AS mi2 
        WHERE ((mi2.info_type_id = 3) AND (mi2.info = ANY ('{Drama,Mystery,Romance,Short}'::text[])));
...
WHERE 
 ...
 AND (mi1.info in ('East Germany','Finland','Mexico','Philippines','Sweden','UK')) 
 AND (mi2.info in ('Drama','Mystery','Romance','Short')) 
