...
SELECT sum(pg_lip_bloom_add(2, n.id)) FROM name AS n 
        WHERE (((n.gender)::text = 'm'::text) AND ((n.name_pcode_cf)::text = ANY ('{A4361,B6261,D1232,J5256,M2354,M6256,M6352,R1525,R2632,S3152,S5362,W4525,W5165}'::text[])));
...
WHERE 
 ...
 AND (n.gender in ('m')) 
 AND (n.name_pcode_cf in ('A4361','B6261','D1232','J5256','M2354','M6256','M6352','R1525','R2632','S3152','S5362','W4525','W5165')) 
 AND (t.production_year <= 2015) 
 AND (t.production_year >= 1925) 
 AND (cn.name in ('Columbia Broadcasting System (CBS)','Fox Network','National Broadcasting Company (NBC)','Paramount Pictures','Shout! Factory','Sony Pictures Home Entertainment','Universal Pictures','Warner Bros')) 
