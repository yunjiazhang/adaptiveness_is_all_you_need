...
WHERE 
 ...
 AND (mi1.info IN ('Australia:G','Australia:M','France:U','Netherlands:12','Portugal:M/12','UK:15','USA:Not Rated','USA:R')) 
 AND (it1.id IN ('5')) 
 AND it3.id = '100' 
 AND it4.id = '101' 
 ...
 AND (n.gender in ('f','m')) 
 AND (n.name_pcode_nf in ('A4215','B6232','C6542','D5423','G5362','G6435','J6525','L6521','M5416','N3425','W4562')) 
 AND (ci.note IS NULL) 
