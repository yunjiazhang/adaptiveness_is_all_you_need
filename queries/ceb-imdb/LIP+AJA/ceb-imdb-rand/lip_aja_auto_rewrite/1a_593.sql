...
WHERE 
 ...
 AND mi1.info IN ('Action','Adult','Comedy','Documentary','Drama','Horror','Short','Talk-Show') 
 AND mi2.info IN ('Cantonese','English','Filipino','Hebrew','Japanese','Spanish','Turkish') 
