...
SELECT sum(pg_lip_bloom_add(0, mi1.movie_id)) FROM movie_info AS mi1 
        WHERE ((mi1.info_type_id = 4) AND (mi1.info = ANY ('{English,French,Spanish}'::text[])));
...
WHERE 
 ...
 AND (mi1.info in ('English','French','Spanish')) 
 AND (mi2.info in ('25','30','5','50','60','75','85','90','Argentina:30','UK:30','USA:30','USA:60')) 
