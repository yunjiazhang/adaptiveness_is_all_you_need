...
SELECT sum(pg_lip_bloom_add(0, mi1.movie_id)), sum(pg_lip_bloom_add(1, mi1.movie_id)) FROM movie_info AS mi1 
        WHERE (mi1.info = ANY ('{"New York City, New York, USA","Paramount Studios - 5555 Melrose Avenue, Hollywood, Los Angeles, California, USA"}'::text[])) AND (mi1.info = ANY ('{"New York City, New York, USA","Paramount Studios - 5555 Melrose Avenue, Hollywood, Los Angeles, California, USA"}'::text[]));
...
SELECT sum(pg_lip_bloom_add(3, n.id)) FROM name AS n 
        WHERE ((((n.gender)::text = 'm'::text) OR (n.gender IS NULL)) AND (((n.name_pcode_nf)::text = ANY ('{A5351,A5352,C6231,C6421,J5253,M2426,P3616,R1632,R1634,S3152,V4356}'::text[])) OR (n.name_pcode_nf IS NULL)));
...
WHERE 
 ...
 AND (n.name_pcode_nf in ('A5351','A5352','C6231','C6421','J5253','M2426','P3616','R1632','R1634','S3152','V4356') OR n.name_pcode_nf IS NULL) 
