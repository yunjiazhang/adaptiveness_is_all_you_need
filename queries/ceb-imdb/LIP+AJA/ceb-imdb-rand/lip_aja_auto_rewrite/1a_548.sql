...
SELECT sum(pg_lip_bloom_add(0, mi2.movie_id)) FROM movie_info AS mi2 
        WHERE ((mi2.info_type_id = 4) AND (mi2.info = ANY ('{Arabic,Catalan,Chinese,Czech,English,Estonian,Filipino,German,Greek,Korean,Persian,Russian,"Swiss German",Thai}'::text[])));
