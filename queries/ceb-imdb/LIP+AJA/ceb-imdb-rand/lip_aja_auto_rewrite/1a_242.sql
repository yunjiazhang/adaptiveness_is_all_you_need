...
WHERE 
 ...
 AND mi1.info IN ('Action','Adventure','Documentary','Horror','Mystery','Short','Thriller') 
 AND mi2.info IN ('Danish','Dutch','English','German','Italian','Japanese','Portuguese','Spanish') 
