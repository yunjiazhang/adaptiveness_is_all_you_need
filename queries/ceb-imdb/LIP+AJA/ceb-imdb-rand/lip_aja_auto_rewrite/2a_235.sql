...
WHERE 
 ...
 AND (mi1.info in ('Adult','Comedy','Crime','Drama','Horror','Romance','Thriller')) 
 AND (mi2.info in ('Hong Kong:IIB','Netherlands:12','Netherlands:AL','Singapore:PG','UK:15','UK:PG','UK:R18','UK:U','USA:Not Rated','USA:Passed','USA:R')) 
