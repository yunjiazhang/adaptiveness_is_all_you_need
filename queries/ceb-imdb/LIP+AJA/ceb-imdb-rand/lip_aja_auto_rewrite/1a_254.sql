...
SELECT sum(pg_lip_bloom_add(0, mi2.movie_id)) FROM movie_info AS mi2 
        WHERE ((mi2.info_type_id = 4) AND (mi2.info = ANY ('{Arabic,Croatian,English,French,German,Mandarin,Russian,Spanish}'::text[])));
...
WHERE 
 ...
 AND mi1.info IN ('Croatia','Cuba','Czech Republic','France','Taiwan','UK','USA') 
 AND mi2.info IN ('Arabic','Croatian','English','French','German','Mandarin','Russian','Spanish') 
