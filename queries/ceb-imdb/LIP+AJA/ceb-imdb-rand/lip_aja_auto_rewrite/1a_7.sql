...
SELECT sum(pg_lip_bloom_add(0, mi2.movie_id)) FROM movie_info AS mi2 
        WHERE ((mi2.info_type_id = 4) AND (mi2.info = ANY ('{Albanian,Croatian,English,German,Malay,Oriya,Romanian,Spanish,"Swiss German"}'::text[])));
...
WHERE 
 ...
 AND mi1.info IN ('Albania','Colombia','Croatia','Denmark','East Germany','India','Malaysia','Peru','Romania','Switzerland') 
 AND mi2.info IN ('Albanian','Croatian','English','German','Malay','Oriya','Romanian','Spanish','Swiss German') 
