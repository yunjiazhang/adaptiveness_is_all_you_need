...
SELECT sum(pg_lip_bloom_add(0, mi1.movie_id)), sum(pg_lip_bloom_add(1, mi1.movie_id)) FROM movie_info AS mi1 
        WHERE (mi1.info = '90'::text) AND (mi1.info = '90'::text);
...
SELECT sum(pg_lip_bloom_add(3, n.id)) FROM name AS n 
        WHERE ((((n.gender)::text = ANY ('{f,m}'::text[])) OR (n.gender IS NULL)) AND (((n.name_pcode_nf)::text = ANY ('{A4253,A5362,B6535,C6235,E4213,F6525,R1631,R1632,S3152}'::text[])) OR (n.name_pcode_nf IS NULL)));
...
WHERE 
 ...
 AND (n.name_pcode_nf in ('A4253','A5362','B6535','C6235','E4213','F6525','R1631','R1632','S3152') OR n.name_pcode_nf IS NULL) 
