...
SELECT sum(pg_lip_bloom_add(0, mi2.movie_id)) FROM movie_info AS mi2 
        WHERE ((mi2.info_type_id = 4) AND (mi2.info = ANY ('{Cantonese,Catalan,Czech,English,French}'::text[])));
...
WHERE 
 ...
 AND mi1.info IN ('Belgium','Canada','Czech Republic','Hong Kong','Spain') 
 AND mi2.info IN ('Cantonese','Catalan','Czech','English','French') 
