...
SELECT sum(pg_lip_bloom_add(2, n.id)) FROM name AS n 
        WHERE ((((n.gender)::text = 'f'::text) OR (n.gender IS NULL)) AND (((n.name_pcode_nf)::text = ANY ('{B6161,C6235,D5162,J5215,K6235,M6216}'::text[])) OR (n.name_pcode_nf IS NULL)));
...
WHERE 
 ...
 AND (n.name_pcode_nf in ('B6161','C6235','D5162','J5215','K6235','M6216') OR n.name_pcode_nf IS NULL) 
