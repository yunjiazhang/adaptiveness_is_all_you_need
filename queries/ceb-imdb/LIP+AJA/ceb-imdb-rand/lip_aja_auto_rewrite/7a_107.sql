...
WHERE 
 ...
 AND (mi1.info IN ('Dutch','Filipino','French','German','Greek','Hindi','Japanese','Mandarin','Russian','Spanish','Tagalog')) 
 AND (it1.id IN ('104','106','4')) 
 AND it3.id = '100' 
 AND it4.id = '101' 
 ...
 AND (n.gender in ('m')) 
 AND (n.name_pcode_nf in ('B6326','D5362','F6523','F6525','F6532','H5252','H5625','J5242','J5251','J6241','M6351','T525','T5263')) 
 AND (ci.note IS NULL) 
