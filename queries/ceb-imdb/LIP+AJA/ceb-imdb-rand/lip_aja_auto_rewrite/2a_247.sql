...
/*+
NestLoop(mi1 t kt mi2 ci rt n it1 it2 mk k)
NestLoop(mi1 t kt mi2 ci rt n it1 it2 mk)
...
SeqScan(kt)
SeqScan(rt)
Leading(((((((((((mi1 t) kt) mi2) ci) rt) n) it1) it2) mk) k))
*/
 SELECT COUNT(*) 
FROM 
(
