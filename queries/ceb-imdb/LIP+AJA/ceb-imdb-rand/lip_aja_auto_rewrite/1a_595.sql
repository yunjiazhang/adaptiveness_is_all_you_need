...
SELECT sum(pg_lip_bloom_add(0, mi2.movie_id)) FROM movie_info AS mi2 
        WHERE ((mi2.info_type_id = 7) AND (mi2.info = ANY ('{"MET:200 m","OFM:35 mm","RAT:1.33 : 1","RAT:2.35 : 1"}'::text[])));
...
WHERE 
 ...
 AND mi1.info IN ('Biography','Comedy','Thriller','Western') 
 AND mi2.info IN ('MET:200 m','OFM:35 mm','RAT:1.33 : 1','RAT:2.35 : 1') 
