...
SELECT sum(pg_lip_bloom_add(0, mi1.movie_id)) FROM movie_info AS mi1 
        WHERE ((mi1.info_type_id = 7) AND (mi1.info = ANY ('{"OFM:35 mm",OFM:Video,PFM:Video,"RAT:1.33 : 1"}'::text[])));
...
WHERE 
 ...
 AND (mi1.info in ('OFM:35 mm','OFM:Video','PFM:Video','RAT:1.33 : 1')) 
 AND (mi2.info in ('30','92','Argentina:30','USA:30')) 
