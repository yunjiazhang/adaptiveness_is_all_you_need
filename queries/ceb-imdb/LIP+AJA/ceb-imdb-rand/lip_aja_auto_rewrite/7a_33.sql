...
WHERE 
 ...
 AND (mi1.info IN ('Black AND White','Color','English','French','German','Italian','Japanese','Spanish')) 
 AND (it1.id IN ('103','2','4')) 
 AND it3.id = '100' 
 AND it4.id = '101' 
 ...
 AND (n.name_pcode_nf in ('A4253','A5242','B6165','J3261','J5162','M6232','M6242','M6252','P3625','S2525','S3521')) 
 AND (ci.note IS NULL) 
