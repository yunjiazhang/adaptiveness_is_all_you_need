...
WHERE 
 ...
 AND (mi1.info IN ('Danish','Finland:S','Iceland:16','Korean','Singapore:PG','Sweden:Btl','Telugu','UK:18','USA:PG','USA:PG-13','USA:Passed','West Germany:12')) 
 AND (it1.id IN ('3','4','5')) 
 AND it3.id = '100' 
 AND it4.id = '101' 
 ...
 AND (n.name_pcode_nf in ('A5162','A5362','D132','H5163','J2642','J5253','J5352','N2421','P4125') OR n.name_pcode_nf IS NULL) 
 AND (ci.note IS NULL) 
