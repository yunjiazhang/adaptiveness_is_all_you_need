...
SELECT sum(pg_lip_bloom_add(0, mi1.movie_id)), sum(pg_lip_bloom_add(1, mi1.movie_id)) FROM movie_info AS mi1 
        WHERE ((mi1.info = ANY ('{"Desilu Studios - 9336 W. Washington Blvd., Culver City, California, USA","Universal Studios - 100 Universal City Plaza, Universal City, California, USA"}'::text[])) AND (mi1.info_type_id = 18)) AND ((mi1.info = ANY ('{"Desilu Studios - 9336 W. Washington Blvd., Culver City, California, USA","Universal Studios - 100 Universal City Plaza, Universal City, California, USA"}'::text[])) AND (mi1.info_type_id = 18));
...
SELECT sum(pg_lip_bloom_add(3, n.id)) FROM name AS n 
        WHERE (((n.gender)::text = 'm'::text) AND ((n.name_pcode_nf)::text = ANY ('{A4253,C6231,C6235,D1325,F6523,F6524,J5165,J5216,J5242,M2416,P3623,R1636,R2634,R2635,S2153}'::text[])));
...
WHERE 
 ...
 AND (mi1.info IN ('Desilu Studios - 9336 W. Washington Blvd., Culver City, California, USA','Universal Studios - 100 Universal City Plaza, Universal City, California, USA')) 
 AND (it1.id IN ('18')) 
 AND it3.id = '100' 
 AND it4.id = '101' 
 ...
 AND (n.gender in ('m')) 
 AND (n.name_pcode_nf in ('A4253','C6231','C6235','D1325','F6523','F6524','J5165','J5216','J5242','M2416','P3623','R1636','R2634','R2635','S2153')) 
 AND (ci.note IS NULL) 
