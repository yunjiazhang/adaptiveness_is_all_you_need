...
SELECT sum(pg_lip_bloom_add(0, mi2.movie_id)) FROM movie_info AS mi2 
        WHERE ((mi2.info_type_id = 8) AND (mi2.info = ANY ('{"Hong Kong",Italy,UK,USA}'::text[])));
...
WHERE 
 ...
 AND (mi1.info in ('CAM:Arriflex Cameras','LAB:DeLuxe','OFM:35 mm','PCS:Spherical','PFM:16 mm','RAT:1.33 : 1','RAT:16:9 HD','RAT:2.35 : 1')) 
 AND (mi2.info in ('Hong Kong','Italy','UK','USA')) 
