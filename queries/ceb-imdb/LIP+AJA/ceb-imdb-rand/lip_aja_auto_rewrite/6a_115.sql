...
SELECT sum(pg_lip_bloom_add(0, mi1.movie_id)), sum(pg_lip_bloom_add(1, mi1.movie_id)) FROM movie_info AS mi1 
        WHERE (mi1.info = 'Mono'::text) AND (mi1.info = 'Mono'::text);
...
SELECT sum(pg_lip_bloom_add(3, n.id)) FROM name AS n 
        WHERE ((((n.gender)::text = 'f'::text) OR (n.gender IS NULL)) AND (((n.name_pcode_nf)::text = ANY ('{B6161,B6162,C6235,C6416,C6452,E4213,J5215,M6263}'::text[])) OR (n.name_pcode_nf IS NULL)));
...
WHERE 
 ...
 AND (n.name_pcode_nf in ('B6161','B6162','C6235','C6416','C6452','E4213','J5215','M6263') OR n.name_pcode_nf IS NULL) 
 AND (ci.note IS NULL) 
