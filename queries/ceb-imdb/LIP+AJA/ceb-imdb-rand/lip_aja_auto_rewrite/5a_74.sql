...
SELECT sum(pg_lip_bloom_add(0, mi1.movie_id)), sum(pg_lip_bloom_add(1, mi1.movie_id)) FROM movie_info AS mi1 
        WHERE (mi1.info = ANY ('{Argentina:13,Finland:K-16,Mandarin,Netherlands:12,Singapore:PG,Tagalog,Turkish,UK:18,UK:PG,"USA:Not Rated",USA:Passed}'::text[])) AND (mi1.info = ANY ('{Argentina:13,Finland:K-16,Mandarin,Netherlands:12,Singapore:PG,Tagalog,Turkish,UK:18,UK:PG,"USA:Not Rated",USA:Passed}'::text[]));
...
WHERE 
 ...
 AND (mi1.info IN ('Argentina:13','Finland:K-16','Mandarin','Netherlands:12','Singapore:PG','Tagalog','Turkish','UK:18','UK:PG','USA:Not Rated','USA:Passed')) 
 AND (it1.id IN ('2','4','5')) 
 AND it3.id = '100' 
 AND it4.id = '101' 
