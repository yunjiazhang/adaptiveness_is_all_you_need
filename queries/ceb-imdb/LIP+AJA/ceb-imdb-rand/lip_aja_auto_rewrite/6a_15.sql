...
WHERE 
 ...
 AND (mi1.info IN ('Dolby Digital','Dolby SR','Dolby','Los Angeles, California, USA','New York City, New York, USA','Stereo')) 
 AND (it1.id IN ('18','6','97')) 
 AND it3.id = '100' 
 AND it4.id = '101' 
 ...
 AND (n.name_pcode_nf in ('A4163','A4236','D5234','G6256','J1626','J2165','J23','M2463','M6232','M6261','M6262','O4161','T6235')) 
