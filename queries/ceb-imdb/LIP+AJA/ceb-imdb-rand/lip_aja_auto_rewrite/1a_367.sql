...
SELECT sum(pg_lip_bloom_add(0, mi2.movie_id)) FROM movie_info AS mi2 
        WHERE ((mi2.info_type_id = 4) AND (mi2.info = ANY ('{English,German,Portuguese,Turkish}'::text[])));
...
WHERE 
 ...
 AND mi1.info IN ('Brazil','East Germany','Germany','Turkey','USA','West Germany') 
 AND mi2.info IN ('English','German','Portuguese','Turkish') 
