...
WHERE 
 ...
 AND (it1.id IN ('2','4')) 
 AND (mi1.info IN ('Arabic','Black AND White','Cantonese','Color','Danish','Dutch','English','Filipino','French','German','Japanese','Korean','Latin','Mandarin','Portuguese','Spanish','Swedish','Tagalog')) 
