...
SELECT sum(pg_lip_bloom_add(1, n.id)) FROM name AS n 
        WHERE (((n.gender)::text = 'f'::text) AND ((n.name_pcode_nf)::text = ANY ('{A4253,A5216,A5263,A5264,B6164,F6523,G1642,J5162,K3652,M6243,M6254,M6523,S1524,T6252}'::text[])));
...
WHERE 
 ...
 AND (mi1.info IN ('Animation','Comedy','Crime','Drama','Horror','Romance','Short','Thriller')) 
 AND (it1.id IN ('13','3')) 
 AND it3.id = '100' 
 AND it4.id = '101' 
 ...
 AND (n.gender in ('f')) 
 AND (n.name_pcode_nf in ('A4253','A5216','A5263','A5264','B6164','F6523','G1642','J5162','K3652','M6243','M6254','M6523','S1524','T6252')) 
 AND (ci.note IS NULL) 
