...
SELECT sum(pg_lip_bloom_add(0, mi2.movie_id)) FROM movie_info AS mi2 
        WHERE ((mi2.info_type_id = 4) AND (mi2.info = ANY ('{English,Greek,Polish,Portuguese,Spanish,Tagalog}'::text[])));
...
WHERE 
 ...
 AND mi1.info IN ('Australia','Greece','Nigeria','Philippines','Poland','Portugal','UK','USA') 
 AND mi2.info IN ('English','Greek','Polish','Portuguese','Spanish','Tagalog') 
