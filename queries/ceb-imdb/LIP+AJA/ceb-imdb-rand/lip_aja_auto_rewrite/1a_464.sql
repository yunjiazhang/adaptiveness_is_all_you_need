...
SELECT sum(pg_lip_bloom_add(0, mi1.movie_id)) FROM movie_info AS mi1 
        WHERE ((mi1.info_type_id = 3) AND (mi1.info = ANY ('{Adventure,Comedy,Documentary,Drama,Short,Western}'::text[])));
...
WHERE 
 ...
 AND mi1.info IN ('Adventure','Comedy','Documentary','Drama','Short','Western') 
 AND mi2.info IN ('MET:600 m','PFM:35 mm','RAT:1.37 : 1','RAT:1.85 : 1','RAT:16:9 HD') 
