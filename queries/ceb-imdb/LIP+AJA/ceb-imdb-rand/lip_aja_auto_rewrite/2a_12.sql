...
SELECT sum(pg_lip_bloom_add(0, mi1.movie_id)) FROM movie_info AS mi1 
        WHERE ((mi1.info_type_id = 4) AND (mi1.info = ANY ('{Cantonese,Dutch,English,French,German,Hindi,Mandarin,Portuguese,Russian}'::text[])));
...
WHERE 
 ...
 AND (mi1.info in ('Cantonese','Dutch','English','French','German','Hindi','Mandarin','Portuguese','Russian')) 
 AND (mi2.info in ('DTS','Dolby Digital','Dolby SR','Dolby','Mono','Stereo','Ultra Stereo')) 
