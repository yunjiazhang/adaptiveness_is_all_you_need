...
SELECT sum(pg_lip_bloom_add(0, mi1.movie_id)) FROM movie_info AS mi1 
        WHERE mi1.info IN ('Black and White','Color') AND (mi1.info_type_id in ('2'));
...
AND (mi2.info IN ('Cantonese','Danish','Dutch','Filipino','Finnish','French','Hindi','Italian','Mandarin','None','Persian','Polish','Spanish','Swedish','Turkish'))
