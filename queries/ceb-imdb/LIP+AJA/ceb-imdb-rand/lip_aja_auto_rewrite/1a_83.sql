...
WHERE 
 ...
 AND mi1.info IN ('Crime','Documentary','Drama','Mystery','Romance','Sci-Fi','Short','Thriller') 
 AND mi2.info IN ('CAM:Red One Camera','OFM:35 mm','PCS:Digital Intermediate','PCS:Spherical','PFM:35 mm','RAT:1.78 : 1','RAT:1.85 : 1','RAT:16:9 HD') 
