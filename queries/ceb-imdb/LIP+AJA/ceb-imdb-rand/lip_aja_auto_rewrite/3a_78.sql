...
WHERE 
 ...
 AND (k.keyword IN ('bare-breasts','based-on-novel','character-name-in-title','family-relationships','father-daughter-relationship','father-son-relationship','gay','love','male-nudity','murder','non-fiction','revenge','sex')) 
 AND (cn.country_code IN ('[cn]','[cz]','[ee]','[eg]','[il]','[ir]','[is]','[tw]','[xyu]')) 
