...
WHERE 
 ...
 AND (k.keyword IN ('based-on-novel','dancing','friendship','hardcore','hospital','lesbian-sex','male-frontal-nudity','mother-daughter-relationship','singer','surrealism')) 
 AND (cn.country_code IN ('[ar]','[at]','[hu]','[ie]','[it]','[nl]','[ph]','[pt]','[se]','[us]')) 
