...
SELECT sum(pg_lip_bloom_add(0, mi1.movie_id)) FROM movie_info AS mi1 
        WHERE ((mi1.info_type_id = 3) AND (mi1.info = ANY ('{Adult,Adventure,Biography,Drama}'::text[])));
...
WHERE 
 ...
 AND mi1.info IN ('Adult','Adventure','Biography','Drama') 
 AND mi2.info IN ('French','German','Italian','Norwegian') 
