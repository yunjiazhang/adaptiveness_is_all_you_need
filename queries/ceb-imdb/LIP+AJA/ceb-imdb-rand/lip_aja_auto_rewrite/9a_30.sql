...
/*+
NestLoop(it2 it1 mi1 t ci pi n rt kt)
NestLoop(it1 mi1 t ci pi n rt kt)
...
SeqScan(kt)
SeqScan(n)
Leading((it2 (it1 (((((mi1 t) ci) (pi n)) rt) kt))))
*/
...
WHERE 
 ...
 AND (rt.role IN ('actor','actress','composer','costume designer','director','guest','producer','production designer','writer')) 
