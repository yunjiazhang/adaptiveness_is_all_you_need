...
SELECT sum(pg_lip_bloom_add(0, mi1.movie_id)) FROM movie_info AS mi1 
        WHERE ((mi1.info_type_id = 3) AND (mi1.info = ANY ('{Comedy,Drama,History,Horror,Music,Romance,Sci-Fi,Sport}'::text[])));
...
WHERE 
 ...
 AND mi1.info IN ('Comedy','Drama','History','Horror','Music','Romance','Sci-Fi','Sport') 
 AND mi2.info IN ('MET:','OFM:35 mm','PCS:Spherical','RAT:1.37 : 1','RAT:1.85 : 1','RAT:2.35 : 1') 
