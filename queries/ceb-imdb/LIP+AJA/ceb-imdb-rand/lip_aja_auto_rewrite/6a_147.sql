...
SELECT sum(pg_lip_bloom_add(0, mi1.movie_id)), sum(pg_lip_bloom_add(1, mi1.movie_id)) FROM movie_info AS mi1 
        WHERE (mi1.info = ANY ('{Argentina:13,Argentina:Atp,Finland:K-16,Netherlands:12,Singapore:PG,Sweden:15,UK:15,UK:18,UK:PG,USA:Approved,"USA:Not Rated",USA:Passed,USA:R,USA:TV-14}'::text[])) AND (mi1.info = ANY ('{Argentina:13,Argentina:Atp,Finland:K-16,Netherlands:12,Singapore:PG,Sweden:15,UK:15,UK:18,UK:PG,USA:Approved,"USA:Not Rated",USA:Passed,USA:R,USA:TV-14}'::text[]));
...
SELECT sum(pg_lip_bloom_add(3, n.id)) FROM name AS n 
        WHERE ((((n.gender)::text = 'f'::text) OR (n.gender IS NULL)) AND ((n.name_pcode_nf)::text = ANY ('{A4253,A5354,C3654,C6231,G6252,J2152,J23,M2426,M6215,M6312,M6542,R2414,S1652,W5245}'::text[])));
...
WHERE 
 ...
 AND (mi1.info IN ('Argentina:13','Argentina:Atp','Finland:K-16','Netherlands:12','Singapore:PG','Sweden:15','UK:15','UK:18','UK:PG','USA:Approved','USA:Not Rated','USA:Passed','USA:R','USA:TV-14')) 
 AND (it1.id IN ('15','5')) 
 AND it3.id = '100' 
 AND it4.id = '101' 
 ...
 AND (n.name_pcode_nf in ('A4253','A5354','C3654','C6231','G6252','J2152','J23','M2426','M6215','M6312','M6542','R2414','S1652','W5245')) 
