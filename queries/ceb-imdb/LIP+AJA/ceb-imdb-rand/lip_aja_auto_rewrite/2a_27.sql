...
SELECT sum(pg_lip_bloom_add(0, mi1.movie_id)) FROM movie_info AS mi1 
        WHERE ((mi1.info_type_id = 8) AND (mi1.info = ANY ('{France,Germany,Italy,Japan,Portugal,Spain,UK,USA,"West Germany"}'::text[])));
...
WHERE 
 ...
 AND (mi1.info in ('France','Germany','Italy','Japan','Portugal','Spain','UK','USA','West Germany')) 
 AND (mi2.info in ('OFM:35 mm','PCS:Spherical','PFM:16 mm','PFM:35 mm','RAT:1.33 : 1')) 
