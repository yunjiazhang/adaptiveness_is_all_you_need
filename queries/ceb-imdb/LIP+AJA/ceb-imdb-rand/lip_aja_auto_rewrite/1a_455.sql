...
WHERE 
 ...
 AND mi1.info IN ('Belgium','Cuba','Denmark','Hungary','India','Israel','Nigeria','Sweden','Switzerland','UK','USA') 
 AND mi2.info IN ('English','French','German','Kannada','Marathi','Russian','Spanish','Yoruba') 
