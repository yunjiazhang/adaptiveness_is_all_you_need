...
SELECT sum(pg_lip_bloom_add(0, mi2.movie_id)) FROM movie_info AS mi2 
        WHERE ((mi2.info_type_id = 4) AND (mi2.info = ANY ('{Cantonese,Catalan,Czech,English,French,Hungarian,Russian,Spanish}'::text[])));
...
WHERE 
 ...
 AND mi1.info IN ('Belgium','Czech Republic','France','Hong Kong','Hungary','Italy','Japan','Russia','Spain') 
 AND mi2.info IN ('Cantonese','Catalan','Czech','English','French','Hungarian','Russian','Spanish') 
