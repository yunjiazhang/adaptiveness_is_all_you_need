...
SELECT sum(pg_lip_bloom_add(2, mi2.movie_id)), sum(pg_lip_bloom_add(3, mi2.movie_id)) FROM movie_info AS mi2 
        WHERE ((mi2.info_type_id = 8) AND (mi2.info = ANY ('{Belgium,France,Germany,India,Japan,"Soviet Union",UK,USA,"West Germany",Yugoslavia}'::text[]))) AND ((mi2.info_type_id = 8) AND (mi2.info = ANY ('{Belgium,France,Germany,India,Japan,"Soviet Union",UK,USA,"West Germany",Yugoslavia}'::text[])));
