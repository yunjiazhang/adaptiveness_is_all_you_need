...
SELECT sum(pg_lip_bloom_add(0, mi1.movie_id)), sum(pg_lip_bloom_add(1, mi1.movie_id)) FROM movie_info AS mi1 
        WHERE (mi1.info = ANY ('{Argentina:16,"CAM:Panavision Cameras AND Lenses",Canada:PG,France:U,Germany:12,Germany:16,Iceland:16,"PCS:Super 35","PFM:16 mm","RAT:1.37 : 1","RAT:1.78 : 1 / (high definition)",Sweden:15,UK:18,UK:PG,"USA:Not Rated",USA:TV-PG}'::text[])) AND (mi1.info = ANY ('{Argentina:16,"CAM:Panavision Cameras AND Lenses",Canada:PG,France:U,Germany:12,Germany:16,Iceland:16,"PCS:Super 35","PFM:16 mm","RAT:1.37 : 1","RAT:1.78 : 1 / (high definition)",Sweden:15,UK:18,UK:PG,"USA:Not Rated",USA:TV-PG}'::text[]));
...
SELECT sum(pg_lip_bloom_add(3, n.id)) FROM name AS n 
        WHERE ((((n.gender)::text = 'f'::text) OR (n.gender IS NULL)) AND ((n.name_pcode_nf)::text = ANY ('{A525,A5363,C6235,C6525,D525,E4525,J5245,L252,M62,M6245,M6532,M6562,R5316,S652}'::text[])));
