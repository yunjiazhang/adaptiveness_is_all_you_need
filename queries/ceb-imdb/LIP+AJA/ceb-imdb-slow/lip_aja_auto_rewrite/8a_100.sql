...
SELECT sum(pg_lip_bloom_add(2, n.id)) FROM name AS n 
        WHERE ((((n.gender)::text = 'm'::text) OR (n.gender IS NULL)) AND (((n.name_pcode_nf)::text = ANY ('{A4163,B1626,C6421,F6523,F6524,F6525,J5252,M6216,R1632,R2631,S3152}'::text[])) OR (n.name_pcode_nf IS NULL)));
