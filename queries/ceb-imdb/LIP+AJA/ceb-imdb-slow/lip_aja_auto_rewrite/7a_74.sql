...
SELECT sum(pg_lip_bloom_add(0, mi1.movie_id)), sum(pg_lip_bloom_add(1, mi1.movie_id)) FROM movie_info AS mi1 
        WHERE (mi1.info = 'Desilu Studios - 9336 W. Washington Blvd., Culver City, California, USA'::text) AND (mi1.info = 'Desilu Studios - 9336 W. Washington Blvd., Culver City, California, USA'::text);
...
SELECT sum(pg_lip_bloom_add(3, n.id)) FROM name AS n 
        WHERE (((n.gender)::text = 'm'::text) AND (((n.name_pcode_nf)::text = ANY ('{C6231,F6525,M6251,P3625,R1631,R1632,R2631,R2632,S2153}'::text[])) OR (n.name_pcode_nf IS NULL)));
