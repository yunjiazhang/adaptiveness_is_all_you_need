...
SELECT sum(pg_lip_bloom_add(0, mi1.movie_id)), sum(pg_lip_bloom_add(1, mi1.movie_id)) FROM movie_info AS mi1 
        WHERE ((mi1.info_type_id = 6) AND (mi1.info = 'Silent'::text)) AND ((mi1.info_type_id = 6) AND (mi1.info = 'Silent'::text));
...
SELECT sum(pg_lip_bloom_add(3, n.id)) FROM name AS n 
        WHERE (((n.gender)::text = 'm'::text) AND ((n.name_pcode_nf)::text = ANY ('{A6362,B6563,C6426,E3632,F6362,F6526,F6532,G6216,H6163,R1635,R2632,S2534,V4356,W4362}'::text[])));
