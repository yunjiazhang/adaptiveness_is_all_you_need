...
SELECT sum(pg_lip_bloom_add(1, n.id)) FROM name AS n 
        WHERE (((n.gender)::text = 'm'::text) AND (((n.name_pcode_nf)::text = ANY ('{A4163,A4253,A5362,C6421,C6423,C6424,C6425,E6523,F6521,F6524,F6525,R1632}'::text[])) OR (n.name_pcode_nf IS NULL)));
