...
SELECT sum(pg_lip_bloom_add(2, mi2.movie_id)), sum(pg_lip_bloom_add(3, mi2.movie_id)) FROM movie_info AS mi2 
        WHERE ((mi2.info_type_id = 18) AND (mi2.info = 'Metro-Goldwyn-Mayer Studios - 10202 W. Washington Blvd., Culver City, California, USA'::text)) AND ((mi2.info_type_id = 18) AND (mi2.info = 'Metro-Goldwyn-Mayer Studios - 10202 W. Washington Blvd., Culver City, California, USA'::text));
