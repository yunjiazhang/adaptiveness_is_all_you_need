...
SELECT sum(pg_lip_bloom_add(2, n.id)) FROM name AS n 
        WHERE (((n.gender)::text = ANY ('{f,m}'::text[])) AND (((n.name_pcode_nf)::text = ANY ('{B1626,C6426,F6521,F6524,J52,J5265,J5425,R1631,R1635,R1636,R2632,R2635}'::text[])) OR (n.name_pcode_nf IS NULL)));
