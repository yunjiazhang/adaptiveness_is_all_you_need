...
SELECT sum(pg_lip_bloom_add(2, n.id)) FROM name AS n 
        WHERE ((((n.gender)::text = 'm'::text) OR (n.gender IS NULL)) AND ((n.name_pcode_cf)::text = ANY ('{A4361,B6525,C6325,G6262,J5256,P3625,P6252,R2632,S1452,S4153,T5212,W4525}'::text[])));
