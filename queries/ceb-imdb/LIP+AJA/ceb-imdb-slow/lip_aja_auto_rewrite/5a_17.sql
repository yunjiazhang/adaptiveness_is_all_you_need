...
SELECT sum(pg_lip_bloom_add(0, mi1.movie_id)), sum(pg_lip_bloom_add(1, mi1.movie_id)) FROM movie_info AS mi1 
        WHERE (mi1.info = ANY ('{Australia:M,Finland:K-16,Portugal:M/12,Sport,"USA:Not Rated",USA:PG,War}'::text[])) AND (mi1.info = ANY ('{Australia:M,Finland:K-16,Portugal:M/12,Sport,"USA:Not Rated",USA:PG,War}'::text[]));
