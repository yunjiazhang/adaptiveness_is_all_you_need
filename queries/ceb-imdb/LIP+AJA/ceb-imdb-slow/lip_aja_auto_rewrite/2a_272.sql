...
SELECT sum(pg_lip_bloom_add(0, mi2.movie_id)) FROM movie_info AS mi2 
        WHERE ((mi2.info_type_id = 5) AND (mi2.info = ANY ('{Australia:G,Finland:K-16,Finland:S,Sweden:Btl,UK:A,UK:PG,USA:Approved,USA:Passed,USA:R,USA:TV-G,"West Germany:12","West Germany:18"}'::text[])));
