...
SELECT sum(pg_lip_bloom_add(0, mi2.movie_id)) FROM movie_info AS mi2 
        WHERE ((mi2.info_type_id = 5) AND (mi2.info = ANY ('{Argentina:16,Finland:K-12,Iceland:16,Iceland:L,India:U,Portugal:M/12,Singapore:PG,USA:PG,USA:TV-PG,USA:Unrated}'::text[])));
