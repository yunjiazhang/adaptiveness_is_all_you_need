...
SELECT sum(pg_lip_bloom_add(0, mi1.movie_id)), sum(pg_lip_bloom_add(1, mi1.movie_id)) FROM movie_info AS mi1 
        WHERE (mi1.info = ANY ('{France,French,Italian,Japan,Japanese,OFM:Live,"RAT:2.35 : 1",Spain}'::text[])) AND (mi1.info = ANY ('{France,French,Italian,Japan,Japanese,OFM:Live,"RAT:2.35 : 1",Spain}'::text[]));
