...
SELECT sum(pg_lip_bloom_add(0, mi1.movie_id)), sum(pg_lip_bloom_add(1, mi1.movie_id)) FROM movie_info AS mi1 
        WHERE (mi1.info = ANY ('{Argentina:13,Australia:PG,Filipino,Finland:S,Greek,Netherlands:12,Singapore:PG,Swedish,"USA:Not Rated",USA:Passed,USA:TV-14}'::text[])) AND (mi1.info = ANY ('{Argentina:13,Australia:PG,Filipino,Finland:S,Greek,Netherlands:12,Singapore:PG,Swedish,"USA:Not Rated",USA:Passed,USA:TV-14}'::text[]));
