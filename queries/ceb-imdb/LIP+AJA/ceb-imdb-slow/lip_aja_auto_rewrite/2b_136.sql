...
SELECT sum(pg_lip_bloom_add(0, mi1.movie_id)), sum(pg_lip_bloom_add(1, mi1.movie_id)) FROM movie_info AS mi1 
        WHERE ((mi1.info_type_id = 5) AND (mi1.info = ANY ('{Australia:M,Finland:K-18,Germany:12,Germany:18,Iceland:12,Iceland:L,Netherlands:6,Norway:15,Spain:T,Sweden:11,Sweden:Btl,UK:12}'::text[]))) AND ((mi1.info_type_id = 5) AND (mi1.info = ANY ('{Australia:M,Finland:K-18,Germany:12,Germany:18,Iceland:12,Iceland:L,Netherlands:6,Norway:15,Spain:T,Sweden:11,Sweden:Btl,UK:12}'::text[])));
