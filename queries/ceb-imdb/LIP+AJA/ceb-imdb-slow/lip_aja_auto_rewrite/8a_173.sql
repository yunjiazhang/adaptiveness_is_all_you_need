...
SELECT sum(pg_lip_bloom_add(0, mi1.movie_id)), sum(pg_lip_bloom_add(1, mi1.movie_id)) FROM movie_info AS mi1 
        WHERE ((mi1.info_type_id = 18) AND (mi1.info = ANY ('{"CBS Television City - 7800 Beverly Blvd., Fairfax, Los Angeles, California, USA","General Service Studios - 1040 N. Las Palmas, Hollywood, Los Angeles, California, USA","Los Angeles, California, USA","Republic Studios - 4024 Radford Avenue, North Hollywood, Los Angeles, California, USA","Stage 28, Warner Brothers Burbank Studios - 4000 Warner Boulevard, Burbank, California, USA"}'::text[]))) AND ((mi1.info_type_id = 18) AND (mi1.info = ANY ('{"CBS Television City - 7800 Beverly Blvd., Fairfax, Los Angeles, California, USA","General Service Studios - 1040 N. Las Palmas, Hollywood, Los Angeles, California, USA","Los Angeles, California, USA","Republic Studios - 4024 Radford Avenue, North Hollywood, Los Angeles, California, USA","Stage 28, Warner Brothers Burbank Studios - 4000 Warner Boulevard, Burbank, California, USA"}'::text[])));
SELECT sum(pg_lip_bloom_add(2, n.id)) FROM name AS n 
        WHERE ((((n.gender)::text = 'm'::text) OR (n.gender IS NULL)) AND ((n.name_pcode_cf)::text = ANY ('{A5362,B6262,G6262,H5362,H5435,M2354,M6253,R1632,R5432,W4526}'::text[])));
