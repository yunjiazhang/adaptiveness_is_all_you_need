...
SELECT sum(pg_lip_bloom_add(3, n.id)) FROM name AS n 
        WHERE ((((n.gender)::text = 'm'::text) OR (n.gender IS NULL)) AND ((n.name_pcode_nf)::text = ANY ('{A5352,A5362,F6521,F6523,J525,J5252,J5262,M2426,R1631,R1632,R2636,S3152}'::text[])));
