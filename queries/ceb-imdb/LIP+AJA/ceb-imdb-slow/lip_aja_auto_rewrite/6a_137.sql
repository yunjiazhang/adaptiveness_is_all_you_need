...
SELECT sum(pg_lip_bloom_add(0, mi1.movie_id)), sum(pg_lip_bloom_add(1, mi1.movie_id)) FROM movie_info AS mi1 
        WHERE ((mi1.info_type_id = 8) AND (mi1.info = ANY ('{Belgium,Finland,"Hong Kong",Ireland,Portugal,"South Korea","Soviet Union"}'::text[]))) AND ((mi1.info_type_id = 8) AND (mi1.info = ANY ('{Belgium,Finland,"Hong Kong",Ireland,Portugal,"South Korea","Soviet Union"}'::text[])));
...
SELECT sum(pg_lip_bloom_add(3, n.id)) FROM name AS n 
        WHERE (((n.gender)::text = 'm'::text) AND ((n.name_pcode_nf)::text = ANY ('{A3651,A4216,C6231,D5242,E3636,E6214,G4652,J5231,J6145,J6262,S524,S5265}'::text[])));
