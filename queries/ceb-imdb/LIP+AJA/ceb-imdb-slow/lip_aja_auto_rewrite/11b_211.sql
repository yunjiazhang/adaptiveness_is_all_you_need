...
/*+
NestLoop(it2 it1 mi1 t kt ci rt n pi mc cn ct)
NestLoop(it1 mi1 t kt ci rt n pi mc cn ct)
HashJoin(mi1 t kt ci rt n pi mc cn ct)
NestLoop(mi1 t kt ci rt n pi mc cn)
NestLoop(mi1 t kt ci rt n pi mc)
...
SeqScan(rt)
SeqScan(ct)
Leading((it2 (it1 (((((((((mi1 t) kt) ci) rt) n) pi) mc) cn) ct))))
*/
 SELECT n.gender, 
        rt.role, 
        cn.name, 
