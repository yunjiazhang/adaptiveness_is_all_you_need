...
SELECT sum(pg_lip_bloom_add(1, n.id)) FROM name AS n 
        WHERE ((((n.gender)::text = ANY ('{f,m}'::text[])) OR (n.gender IS NULL)) AND (((n.name_pcode_nf)::text = ANY ('{A4253,A5362,B6535,C6231,C6235,K6235,R1632,R2632,S3152}'::text[])) OR (n.name_pcode_nf IS NULL)));
