...
SELECT sum(pg_lip_bloom_add(0, mi1.movie_id)) FROM movie_info AS mi1 
        WHERE ((mi1.info_type_id = 7) AND (mi1.info = ANY ('{LAB:DeLuxe,LAB:Technicolor,"MET:150 m","MET:300 m","OFM:16 mm","OFM:35 mm","OFM:68 mm",OFM:Video,PFM:Video,"RAT:1.20 : 1","RAT:1.33 : 1"}'::text[])));
