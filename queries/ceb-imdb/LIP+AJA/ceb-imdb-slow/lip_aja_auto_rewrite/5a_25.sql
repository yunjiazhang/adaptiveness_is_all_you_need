...
SELECT sum(pg_lip_bloom_add(0, mi1.movie_id)), sum(pg_lip_bloom_add(1, mi1.movie_id)) FROM movie_info AS mi1 
        WHERE (mi1.info = ANY ('{12,4,45,Argentina:60,"Dolby SR",Singapore:PG,UK:18,UK:PG,USA:60,USA:PG}'::text[])) AND (mi1.info = ANY ('{12,4,45,Argentina:60,"Dolby SR",Singapore:PG,UK:18,UK:PG,USA:60,USA:PG}'::text[]));
