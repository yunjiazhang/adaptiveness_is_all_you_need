...
SELECT sum(pg_lip_bloom_add(0, mi2.movie_id)) FROM movie_info AS mi2 
        WHERE ((mi2.info_type_id = 7) AND (mi2.info = ANY ('{LAB:DeLuxe,"MET:300 m","OFM:35 mm","PFM:16 mm","PFM:35 mm","RAT:1.33 : 1","RAT:1.37 : 1","RAT:1.78 : 1","RAT:1.85 : 1","RAT:16:9 HD","RAT:2.35 : 1"}'::text[])));
