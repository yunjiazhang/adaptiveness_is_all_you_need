...
SELECT sum(pg_lip_bloom_add(0, mi1.movie_id)), sum(pg_lip_bloom_add(1, mi1.movie_id)) FROM movie_info AS mi1 
        WHERE (mi1.info = ANY ('{Adventure,Biography,Fantasy,History,Music,Musical,Mystery,Sci-Fi,Sport,War}'::text[])) AND (mi1.info = ANY ('{Adventure,Biography,Fantasy,History,Music,Musical,Mystery,Sci-Fi,Sport,War}'::text[]));
...
SELECT sum(pg_lip_bloom_add(3, n.id)) FROM name AS n 
        WHERE (((n.gender)::text = 'f'::text) AND ((n.name_pcode_nf)::text = ANY ('{A2425,D1626,D5262,G6435,J5241,J5616,L2524,M6165,M6365,N2432,S1525,S6532,V6412,V6525}'::text[])));
