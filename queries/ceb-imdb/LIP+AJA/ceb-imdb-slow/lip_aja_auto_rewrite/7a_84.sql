...
SELECT sum(pg_lip_bloom_add(2, n.id)) FROM name AS n 
        WHERE (((n.gender)::text = 'm'::text) AND ((n.name_pcode_nf)::text = ANY ('{C6421,C6423,C6424,C6426,F6524,R2632,V4356,W4362}'::text[])));


/*+
NestLoop(mii2 mii1 t mk ci rt n mi1 kt it1 it3 it4 k an pi1 it5)
...
NestLoop(mii2 mii1 t mk ci rt n mi1 kt it1 it3 it4)
NestLoop(mii2 mii1 t mk ci rt n mi1 kt it1 it3)
