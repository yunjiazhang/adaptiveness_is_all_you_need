...
SELECT sum(pg_lip_bloom_add(1, n.id)) FROM name AS n 
        WHERE ((((n.gender)::text = ANY ('{f,m}'::text[])) OR (n.gender IS NULL)) AND (((n.name_pcode_nf)::text = ANY ('{C6231,E4213,F6362,F6525,J513,M6251,M6263,P3625,R1631,R1632,R1636,R2631}'::text[])) OR (n.name_pcode_nf IS NULL)));
