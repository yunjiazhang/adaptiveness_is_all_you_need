...
SELECT sum(pg_lip_bloom_add(0, mi1.movie_id)), sum(pg_lip_bloom_add(1, mi1.movie_id)) FROM movie_info AS mi1 
        WHERE (mi1.info = ANY ('{"OFM:35 mm",OFM:Live,OFM:Video,PCS:Spherical,PFM:Video,"RAT:1.33 : 1","RAT:1.37 : 1","RAT:1.85 : 1"}'::text[])) AND (mi1.info = ANY ('{"OFM:35 mm",OFM:Live,OFM:Video,PCS:Spherical,PFM:Video,"RAT:1.33 : 1","RAT:1.37 : 1","RAT:1.85 : 1"}'::text[]));
...
SELECT sum(pg_lip_bloom_add(3, n.id)) FROM name AS n 
        WHERE (((n.gender)::text = ANY ('{f,m}'::text[])) AND ((n.name_pcode_nf)::text = ANY ('{A5242,A5361,A6361,B6514,B6524,C6452,F6521,J2425,J5163,J5214,M6252,P3625,T5252,W4125,W4361}'::text[])));
